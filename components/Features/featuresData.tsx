...
const featuresData: Feature[] = [
  {
    id: 1,
    icon: "/images/icon/icon-code.svg",
    title: "Technical",
    description:
  ...
  {
    id: 3,
    icon: "/images/icon/icon-editorial.svg",
    title: "Editorial",
    description:
      "Our editorial team composes the blog and encourages people to read it. The team produces high quality research articles.",
  },
  {
    id: 4,
    icon: "/images/icon/icon-publicity.svg",
    title: "Publicity",
    description:
  ...
  {
    id: 5,
    icon: "/images/icon/icon-creative.svg",
    title: "Creative",
    description:
      "The creative team creates posters for all events. During Techfest, the creative team also decorates the department floor.",
  },
  {
    id: 6,
    icon: "/images/icon/icon-media-graphics.svg",
