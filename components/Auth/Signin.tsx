...
import { googleProvider } from "@/src/config/firebaseConfig";
...
function Signin() {
  ...
  useEffect(() => {
    const unsubscribe = onAuthStateChanged(auth, (user) => {
      if (user) {
        ...
        setLoading(false); // Set loading to false once authentication state is evaluated
      }
    });
  ...
  const signInViaEmail = async(e: any) => {
    ...
    const signInViaGoogle = async(e: any) => {
